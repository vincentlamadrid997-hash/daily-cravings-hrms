                ...
                <div class="crud-card">
                    ...
                    <div class="crud-info">
                        ...
                        <div class="crud-info-box">
                            ...
                            <strong><?= date("F d, Y", strtotime($department['created_at'])); ?></strong>
                        </div>
                    ...
                    <div class="crud-info">
                        ...
                        <div class="crud-info-box">
                            ...
                            <strong>#<?= (int) $department['department_id']; ?></strong>
                        </div>

                        <div class="crud-info-box">
                            <span>Record Created</span>
                            <strong><?= date("F d, Y h:i A", strtotime($department['created_at'])); ?></strong>
                        </div>
