...
if (
    ...
    $_SESSION['report_error'] = "Please generate a report first before exporting Excel.";
...
header("Content-Disposition: attachment; filename=" . str_replace(" ", "_", $report_title) . ".xls");
