                ...
                <div class="crud-card">
                    ...
                    <div class="crud-info">
                        ...
                        <div class="crud-info-box">
                            ...
                            <strong><?= htmlspecialchars($position['department_name'] ?? "N/A"); ?></strong>
                        </div>
                        ...
                        <div class="crud-info-box">
                            ...
                            <strong><?= date("F d, Y", strtotime($position['created_at'])); ?></strong>
                        </div>
                    ...
                    <div class="crud-info">
                        ...
                        <div class="crud-info-box">
                            ...
                            <strong>#<?= (int) $position['position_id']; ?></strong>
                        </div>

                        <div class="crud-info-box">
                            <span>Record Created</span>
                            <strong><?= date("F d, Y h:i A", strtotime($position['created_at'])); ?></strong>
                        </div>
