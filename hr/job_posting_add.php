...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    requireCSRFToken("job_posting_add.php", "job_error");
    ...
    elseif ($closing_date < $posted_date) {
            ...
            <section class="hr-job-add-page">
                ...
                <div class="hr-job-add-header">
                    ...
                    <div class="hr-job-add-title">
                        ...
                        <p>Create a new company job vacancy.</p>
                ...
                <div class="hr-job-add-card">
                    ...
                    <div class="hr-job-card-header">
                        ...
                        <div>
                            ...
                            <p>Fill up all required job details.</p>
                    ...
                    <div class="hr-job-grid">
                                ...
                                <?php foreach ($departments as $department): ?>
                                    ...
                                    <option
                                        ...
                                        (
                                            ...
                                            $_POST['department_id'] == $department['department_id']
                                        )
                                        ?
                                        "selected"
                                        :
                                ...
                                <?php foreach ($positions as $position): ?>
                                    ...
                                    <option
                                        ...
                                        (
                                            ...
                                            $_POST['position_id'] == $position['position_id']
                                        )
                                        ?
                                        "selected"
                                        :
                            ...
                            >
                                ...
                                <?php foreach ($types as $type): ?>
                                    ...
                                    <option
                                        ...
                                        <?=
                                        (
                                            isset($_POST['employment_type']) &&
                                            $_POST['employment_type'] == $type
                                        )
                                        ?
                                        "selected"
                                        :
                        ...
                        <div class="hr-job-group">
                            ...
                            <input
                                ...
                                name="posted_date"
                                class="hr-job-input"
                                value="<?= $_POST['posted_date'] ?? date('Y-m-d'); ?>"
                            >
                        ...
                        <div class="hr-job-group hr-job-full">
                            ...
                            ><?= htmlspecialchars($_POST['responsibilities'] ?? '') ?></textarea>
