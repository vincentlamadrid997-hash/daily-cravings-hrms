...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update_profile'])) {
    ...
    $profile_picture = $hr['profile_picture'];
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === UPLOAD_ERR_OK) {
        ...
        $newFileName = "hr_" . $user_id . "_" . time() . "." . $fileExtension;
        $uploadPath = $uploadDirectory . $newFileName;

        if (move_uploaded_file($file['tmp_name'], $uploadPath)) {

            $oldPicture = $hr['profile_picture'];
    ...
    try {
        ...
        error_log("HR profile update error: " . $e->getMessage());
...
$avatarPath = "";
if (!empty($hr['profile_picture']) && file_exists("../assets/images/profiles/" . $hr['profile_picture'])) {
    $avatarPath = "../assets/images/profiles/" . $hr['profile_picture'];
} else {
    $avatarPath = $hr['gender'] === 'Male'
        ? "../assets/images/avatar/hr_boy.jpg"
            ...
            <div class="crud-card">
                ...
                <div class="crud-card-header">
                    ...
                    <div>
                        ...
                        <p>Role: <?= htmlspecialchars(ucfirst($hr['role'])); ?> &middot; Member since <?= date("M Y", strtotime($hr['created_at'])); ?></p>
                    </div>
                    ...
                    <div class="crud-form-grid">
                            ...
                            <input type="text" name="full_name" class="profile-tracked" data-initial="<?= htmlspecialchars($hr['full_name']); ?>" required value="<?= htmlspecialchars($hr['full_name']); ?>">
                        </div>
                        ...
                        <div class="crud-form-group">
                            ...
                            <input type="email" name="email" class="profile-tracked" data-initial="<?= htmlspecialchars($hr['email']); ?>" required value="<?= htmlspecialchars($hr['email']); ?>">
                        </div>
                        ...
                        <div class="crud-form-group">
                            ...
                            <select name="gender" class="profile-tracked" data-initial="<?= htmlspecialchars($hr['gender']); ?>" required>
